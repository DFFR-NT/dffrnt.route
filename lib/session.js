...
// REQUIRES
	...
	// General
		// import { default as 	  ROOTD } from 'app-root-path';
		import { default as 	Setting } from '../../../config/settings.js';

	// Header Requires
		import { default as compression } from 'compression';
		import { default as  bodyParser } from 'body-parser';
		import { default as 	 cookie } from 'cookie-parser';
		import { default as 	 crypto } from 'crypto-token';

	// Auth Requires
		import { default  as   passport } from 'passport';
		const 	useLDAP   = !!Setting.Session.LDAP;
		import { Strategy as   loclauth } from 'passport-local';
		import { default  as 		jwt } from 'json-web-token';
	...
	// Session Requires
		...
		import { default  as  connRedis } from 'connect-redis';
...
// EXPORT
	...
	export default function (server, app, connection) {
