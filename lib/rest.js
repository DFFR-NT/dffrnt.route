...
// Remote Handler
	...
	class Remote { 
		...
		/// PROPERTIES //////////////////////////////////////////////////////////////////////
			 ...
			 * @memberof Remote
			 */
			get Methods( ) { return ['GET','PUT','POST','DELETE','MIDDLEWARE']; }
			/**
		...
		/// PROCEDURES //////////////////////////////////////////////////////////////////////
				...
				return (req, res, next) => {
					Promise	.resolve((async (req, res, next) => {
								let ret = await THS._requests(
									...
									usr = ret.payload.result.user;
								console.log('CHECK: good', usr);
								req.profile = usr;
								next();
							})(req, res, next))
							.catch(err => next());
			 ...
			 * @memberof Remote
			 */
			GET (point = '', params = {}, query = {}) {
				return this._requests(point, 'GET',    params, { query: query });
			}
			/**
			 ...
			 * @memberof Remote
			 */
			PUT (point = '', params = {}, body  = {}, files = []) {
				return this._requests(point, 'PUT',    params, { body: body, files: files });
			}
			/**
			 ...
			 * @memberof Remote
			 */
			POST(point = '', params = {}, body  = {}) {
				return this._requests(point, 'POST',   params, { body: body });
			}
			/**
			 ...
			 */
			DEL (point = '', params = {}) {
				return this._requests(point, 'DELETE', params, { body: body });
			}
	}
