...
// General Handler
	...
	class GNRequest { 
		/// CONSTRUCTOR /////////////////////////////////////////////////////////////////////
			 ...
			 * @param {(CLRouteAU|CLRouteDB)} Configs The configurations for the request route 
			 */
			constructor(Name, Configs) {
				 ...
				 * @memberof GNRequest
				 */
				this.Requests = Imm	.OrderedMap(Configs)
								  	.map((v, k)=>(v.Name=k,v));
			}
...
// Auth Handler
	...
	class AURequest extends GNRequest { 
		/// CONSTRUCTOR /////////////////////////////////////////////////////////////////////
			 ...
			 * @param {string} Name The name of the request route
			 * @param {CLRouteAU} Configs The configurations for the request route 
			 */
			constructor(Name, Configs) {
...
// Data Handler
	...
	class DBRequest extends GNRequest { 
		/// CONSTRUCTOR /////////////////////////////////////////////////////////////////////
			 ...
			 * @param {string} Name The name of the request route
			 * @param {CLRouteDB} Configs The configurations for the request route 
			 */
			constructor(Name, Configs) {
				super(Name, Configs); 
				this.Name = Name; 
